...
define('SQLENC', 'TRUE');
define('SQLKEY', 'DATAHERE');

// ** mcrypt database encryption setup ** //

define('CIPHER', 'DATAHERE');
define('CIPHERM', 'DATAHERE'); 
define('EPASS', 'DATAHERE');
define('ESALT', 'DATAHERE'); 
define('EPBALG', 'DATAHERE'); //PBKDF2 hasing alg md5,sha,sha2,sha3
define('EPBI', 'DATAHERE'); //PBKDF2 interation
