...
function decryptuser($user){
	...
	$user->user_nicename=decrypt($user->user_nicename);
	$user->user_url=decrypt($user->user_url);
	$user->user_activation_key=decrypt($user->user_activation_key);
	$user->user_status=decrypt($user->user_status);
	$user->user_registered=decrypt($user->user_registered);
	return $user;
}
